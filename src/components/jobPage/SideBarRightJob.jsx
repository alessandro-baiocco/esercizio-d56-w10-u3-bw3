...
const SideBarRightJob = () => {
  return (
    <div>
      <section className="rounded-3 cardLinkedln">
        <ul className="ps-3">
          <li className="fw-semibold textNoneLi pt-3 ">
            ...
            <span className="ps-2">Le mie offerte di lavoro</span>
          </li>
          <li className="fw-semibold textNoneLi pt-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ps-2">Avvisi offerte di lavoro</span>
          </li>
          <li className="fw-semibold textNoneLi pt-3 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ps-2">Valutazioni delle competenze</span>
          </li>
          <li className="fw-semibold textNoneLi pt-3 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ps-2">Indicazioni per chi cerca lavoro</span>
          </li>
          <li className="fw-semibold textNoneLi pt-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ps-2">Impostazioni candidatura</span>
          </li>
        </ul>
      </section>
      <div>
        <Button className="buttonJob rounded-5 px-5 mt-3">
          <i className="bi bi-pencil-square text-primary pt-2 fs-5"></i>
