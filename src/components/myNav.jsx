...
const MyNav = () => {
  ...
  return (
    <Navbar className="bg-body-tertiary media">
      <Container id="nav-container" className="d-flex align-items-center text-secondary ">
        <div className="d-flex">
          ...
          <Form className="d-flex align-items-center me-auto">
            ...
            <Form.Control type="text" placeholder="cerca" className="d-block" />
          </Form>
        </div>
        ...
        <Nav className="me-auto d-none d-sm-flex">
          <Nav.Link href="/" className="mx-2 widthIconNavBar">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-house-door-fill d-none d-sm-block ms-2"
              viewBox="0 0 16 16"
            >
          ...
          <Nav.Link href="#link" className="mx-2 widthIconNavBar">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-people-fill d-none d-sm-block  ms-1"
              viewBox="0 0 16 16"
            >
              <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
            </svg>
            <p className="mb-0 d-none d-md-block">Rete </p>
          </Nav.Link>
          <Nav.Link href="#link" className="mx-2 widthIconNavBar">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              height="20"
              fill="currentColor"
              className="bi bi-briefcase-fill d-none d-sm-block  ms-2"
              viewBox="0 0 16 16"
            >
          ...
          <Nav.Link href="#link" className="mx-2 pt-1 widthIconNavBar2">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-chat-dots-fill ms40px"
              viewBox="0 0 16 16"
            >
              <path d="M16 8c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7zM5 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
            </svg>
          ...
          <Nav.Link href="#link" className="mx-2 pt-1 widthIconNavBar">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-bell-fill ms-4 svgNotifiche"
              viewBox="0 0 16 16"
            >
          ...
          <div className="d-flex flex-column py-2">
            ...
            <NavDropdown
              ...
              className="d-none d-md-block pt-0 pe-3 border-end widthIconNavBar widthIconNavBar"
            >
          ...
          <div className="d-flex flex-column py-2">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-grid-3x3-gap-fill ms-5 mb-0 pb-0 text-secondary d-none d-sm-block"
              viewBox="0 0 16 16"
            >
            ...
            <button
              onClick={handleShow}
              className="d-none d-md-block border border-0 bg-body-tertiary  px-0 text-secondary text-truncate ms-2"
            >
              per le aziende
            </button>
