        ...
        <div className="d-flex">
          <Navbar.Brand href="/" className=" me-2">
            ...
            <svg
              ...
              height="20"
              fill="currentColor"
              className="bi bi-person-circle d-block d-md-none text-secondary"
              viewBox="0 0 16 16"
            >
          ...
          <Form className="d-flex align-items-center me-auto">
            <div className="text-secondary">
              ...
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-search d-none d-small-block"
                viewBox="0 0 16 16"
              >
                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
              </svg>
              <p className="mb-o d-none d-md-block d-lg-none">cerca</p>
            </div>
